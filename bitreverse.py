...
if __name__ == "__main__":
    ...
    img = cv2.imread('img/qr-Text1000.png', cv2.IMREAD_COLOR)
    ...
    img = example2(img)
    cv2.imwrite("img/bitrev-qr-Text1000.png",img)
    ...
    img = cv2.imread('img/bitrev-qr-Text1000.png', cv2.IMREAD_COLOR)
    ...
    cv2.imwrite("img/result-for-bitrev-qr-Text1000.png",img)
    # # cv2.waitKey(0)
    # pass